            ...
            <div className="invoice-items">
                <div className="accordion-item">
                    <h2 className="accordion-header" id={`heading${props.count}`}>
                        ...
                        <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target={`#collapse${props.count}`} aria-expanded="true" aria-controls={`collapse${props.count}`}>
                            <b>Invoice Number: #{item.invoicenumber}</b>
                        </button>
                        <img src={del} className="accordion-del-img"></img>
                        <img src={edit} className="accordion-edit-img"></img>
                        <img src={download} className="accordion-download-img"></img> 
                        </div>
                    </h2>
                    <div id={`collapse${props.count}`} className="accordion-collapse collapse" aria-labelledby={`heading${props.count}`} data-bs-parent="#accordionExample">
                ...
                <div className='table-box'>
                    <table className="table" id='table'>
                        ...
                        {item.products.map((element) => {
                                return <InvoiceTableItem key={element._id} item={element}
                                  />
