...
const mongoURi=`mongodb+srv://${username}:${password}@cluster0.7emgzhe.mongodb.net/${Appname}?retryWrites=true&w=majority`

// mongodb+srv://Hussain:<password>@cluster0.7emgzhe.mongodb.net/?retryWrites=true&w=majority
